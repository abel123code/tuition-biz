...
function WhyChooseUs() {
  return (
    <div className="bg-black"> {/* Ensure to use className instead of class in JSX */}

      <section id="features"
        className="relative block px-6 py-10 md:py-20 md:px-10 border-t border-b border-neutral-900 bg-neutral-900/30">
        {/* Updated the class attribute to className, which is the correct attribute in JSX */}
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <h2
            className="block w-full bg-gradient-to-b from-white to-gray-400 bg-clip-text font-bold text-transparent text-3xl sm:text-4xl pb-2">
          ...
          <p
            ...
            Our content notes and digital flashcards are designed for optimal learning. Tailor your study sessions and achieve better results with our user-friendly tools.
          </p>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Effective Study Techniques</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              Our learning materials use the best study techniques, including reading slides for comprehension and using flashcards for material retention.
            </p>
          </div>
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Efficient Study</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              Our materials are designed for quick comprehension, helping you maximize your study sessions.
            </p>
          </div>
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Comprehensive Tools</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
              Access all the resources you need to succeed, from flashcards to in-depth content notes.
            </p>
          </div>
